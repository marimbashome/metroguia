...
export async function generateMetadata({ params }) {
  ...
  return {
    title: `The Tide Light Rail ${linea.colorNombre} Line — Norfolk | MetroGuia`,
    description: linea.descripcion.substring(0, 160),
    openGraph: {
      title: `The Tide Light Rail ${linea.colorNombre} Line`,
      description: linea.descripcion.substring(0, 160),
      url: `https://metroguia.mx/norfolk/line/${linea.id}`,
    },
  };
}

export default function LineNorfolkPage({ params }) {
  const linea = lineasNorfolk.find((l) => l.id === params.id);
