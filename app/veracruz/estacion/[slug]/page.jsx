...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    openGraph: {
      ...
      url: `https://metroguia.mx/veracruz/estacion/${estacion.slug}`,
      type: 'website',
    },
    robots: {
      index: true,
    ...
    alternates: {
      canonical: `https://metroguia.mx/veracruz/estacion/${estacion.slug}`,
      languages: {
...
export default function EstacionVeracruzPage({ params }) {
  const estacion = estacionesVeracruz.find((e) => e.slug === params.slug);
  if (!estacion) {
    return (
      <main style={{ padding: '40px 20px', textAlign: 'center' }}>
        ...
        <p style={{ marginTop: '20px' }}>
          <Link href="/veracruz" style={{ color: '#E8473B', textDecoration: 'underline' }}>
            Volver a Veracruz
          </Link>
        </p>
      </main>
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        item: `https://metroguia.mx/veracruz/linea/${estacion.linea}/`
      },
      {
        '@type': 'ListItem',
        position: 4,
        name: estacion.h1,
        item: `https://metroguia.mx/veracruz/estacion/${estacion.slug}/`
      }
    ]
  }
    ...
    <main style={{ backgroundColor: '#ffffff' }}>
      ...
      <section style={{ ...containerStyles, paddingTop: '40px', paddingBottom: '40px' }}>
        ...
        <div style={sidebarStyles}>
          ...
          <ul style={{ fontSize: '14px', color: '#374151', lineHeight: '1.8', paddingLeft: '20px' }}>
            ...
            <li><strong>Corredor:</strong> {linea?.descripcion}</li>
      ...
      <section style={{ ...containerStyles, paddingTop: '40px', paddingBottom: '40px', textAlign: 'center' }}>
        ...
        <div style={{ display: 'flex', gap: '10px', justifyContent: 'center', flexWrap: 'wrap' }}>
          ...
          {linea && (
            <Link href={`/veracruz/linea/${linea.id}`} style={buttonStyles}>
