export const metadata = {
  title: 'RUTA BRT Puebla — Próximamente | MetroGuia',
  description: 'MetroGuia está mapeando el sistema RUTA de transporte de Puebla. Guía turística de RUTA BRT próximamente. Consulta ya nuestras guías de CDMX, Guadalajara y Monterrey.',
}
...
export default function PueblaPage() {
  return (
    <div>
      {/* Hero */}
      <section style={{ background: 'linear-gradient(135deg, #3b1f8c 0%, #111 100%)', color: 'white', padding: '5rem 2rem 4rem', textAlign: 'center' }}>
        <div className="container">
          <p style={{ fontSize: '0.875rem', opacity: 0.7, marginBottom: '0.5rem', letterSpacing: '0.1em', textTransform: 'uppercase' }}>
            <a href="/" style={{ color: 'rgba(255,255,255,0.7)', textDecoration: 'none' }}>MetroGuia</a> → Puebla
          </p>
          ...
          <p style={{ fontSize: '1.1rem', opacity: 0.85, maxWidth: '580px', margin: '0 auto 1rem' }}>
            El sistema RUTA conecta el histórico centro de Puebla con Angelópolis y las principales zonas universitarias mediante 3 corredores de autobús rápido.
          </p>
          <p style={{ opacity: 0.7, fontSize: '0.95rem' }}>Ciudad UNESCO · A 2h de CDMX</p>
        </div>
      </section>
        ...
        <div className="container" style={{ maxWidth: '700px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', gap: '1.5rem', marginBottom: '3rem' }}>
            <div style={{ background: '#f8f9fa', borderRadius: '12px', padding: '1.5rem', textAlign: 'center' }}>
              <div style={{ fontSize: '1.75rem', fontWeight: 800, color: '#8B5CF6', fontFamily: 'Syne, sans-serif' }}>3</div>
              <div style={{ fontSize: '0.8rem', color: '#666', marginTop: '0.25rem' }}>Líneas / Corredores</div>
            </div>
            <div style={{ background: '#f8f9fa', borderRadius: '12px', padding: '1.5rem', textAlign: 'center' }}>
              <div style={{ fontSize: '1.75rem', fontWeight: 800, color: '#8B5CF6', fontFamily: 'Syne, sans-serif' }}>~60</div>
              <div style={{ fontSize: '0.8rem', color: '#666', marginTop: '0.25rem' }}>Estaciones / Paradas</div>
            </div>
            <div style={{ background: '#f8f9fa', borderRadius: '12px', padding: '1.5rem', textAlign: 'center' }}>
              <div style={{ fontSize: '1.75rem', fontWeight: 800, color: '#8B5CF6', fontFamily: 'Syne, sans-serif' }}>~40</div>
              <div style={{ fontSize: '0.8rem', color: '#666', marginTop: '0.25rem' }}>Kilómetros de red</div>
            </div>
          </div>
          <div style={{ background: '#8B5CF615', border: '1px solid #8B5CF630', borderRadius: '12px', padding: '1.5rem', marginBottom: '2.5rem' }}>
            <p style={{ margin: 0, color: '#444', lineHeight: 1.7 }}>
              El sistema RUTA (Red Urbana de Transporte Articulado) conecta el histórico centro de Puebla con Angelópolis y las principales zonas universitarias mediante 3 corredores de autobús rápido. Ideal para turistas que visitan la Catedral, el Zócalo y el barrio de los Sapos.
            </p>
          </div>
