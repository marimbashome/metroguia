...
function getCitiesUrls() {
  const urls = [
    ...
    // English station/line paths for MX cities (bilingual: estacion=es, station=en)
    ...mapEstacionesUSCA(estacionesPuebla, 'puebla', 'cities'),
    ...mapLineasUSCA(lineasPuebla, 'puebla', 'cities'),
    ...mapEstacionesUSCA(estacionesMerida, 'merida', 'cities'),
    ...mapLineasUSCA(lineasMerida, 'merida', 'cities'),
    ...mapEstacionesUSCA(estacionesLeon, 'leon', 'cities'),
    ...mapLineasUSCA(lineasLeon, 'leon', 'cities'),
    ...mapEstacionesUSCA(estacionesChihuahua, 'chihuahua', 'cities'),
    ...mapLineasUSCA(lineasChihuahua, 'chihuahua', 'cities'),
    ...mapEstacionesUSCA(estacionesTijuana, 'tijuana', 'cities'),
    ...mapLineasUSCA(lineasTijuana, 'tijuana', 'cities'),
    ...mapEstacionesUSCA(estacionesQueretaro, 'queretaro', 'cities'),
    ...mapLineasUSCA(lineasQueretaro, 'queretaro', 'cities'),
    ...mapEstacionesUSCA(estacionesToluca, 'toluca', 'cities'),
    ...mapLineasUSCA(lineasToluca, 'toluca', 'cities'),
    ...mapEstacionesUSCA(estacionesTrenMaya, 'tren-maya', 'cities'),
    ...mapLineasUSCA(lineasTrenMaya, 'tren-maya', 'cities'),
    ...mapEstacionesUSCA(estacionesOaxaca, 'oaxaca', 'cities'),
    ...mapLineasUSCA(lineasOaxaca, 'oaxaca', 'cities'),
    ...mapEstacionesUSCA(estacionesMorelia, 'morelia', 'cities'),
    ...mapLineasUSCA(lineasMorelia, 'morelia', 'cities'),
    ...mapEstacionesUSCA(estacionesVeracruz, 'veracruz', 'cities'),
    ...mapLineasUSCA(lineasVeracruz, 'veracruz', 'cities'),
    ...mapEstacionesUSCA(estacionesCampeche, 'campeche', 'cities'),
    ...mapLineasUSCA(lineasCampeche, 'campeche', 'cities'),
    ...mapEstacionesUSCA(estacionesVillahermosa, 'villahermosa', 'cities'),
    ...mapLineasUSCA(lineasVillahermosa, 'villahermosa', 'cities'),
    // NYC
