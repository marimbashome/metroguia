...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    openGraph: {
      ...
      url: `https://metroguia.mx/leon/estacion/${estacion.slug}`,
      type: 'website',
    },
    robots: {
      index: true,
...
export default function EstacionLeonPage({ params }) {
  const estacion = estacionesLeon.find(e => e.slug === params.slug);
      ...
      <section style={heroStyles}>
        <div style={heroContentStyles}>
          ...
          <p style={{ fontSize: '18px', marginBottom: '5px' }}>
            Corredor {estacion.linea} — Optibus SIT León
          </p>
              ...
              <div>
                {pois.map((poi, idx) => (
                  <div key={idx} style={poiItemStyles}>
                    <h4 style={{ fontSize: '15px', fontWeight: 'bold', color: '#10B981', marginBottom: '5px' }}>
                      {poi.nombre}
                    </h4>
