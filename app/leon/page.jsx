export const metadata = {
  title: 'Optibus SIT León — Próximamente | MetroGuia',
  description: 'MetroGuia está mapeando el Sistema Integrado de Transporte de León. Guía turística de SIT León próximamente. Consulta ya nuestras guías de CDMX, Guadalajara y Monterrey.',
}
...
export default function LeonPage() {
  return (
    <div>
      {/* Hero */}
      <section style={{ background: 'linear-gradient(135deg, #064e3b 0%, #111 100%)', color: 'white', padding: '5rem 2rem 4rem', textAlign: 'center' }}>
        <div className="container">
          <p style={{ fontSize: '0.875rem', opacity: 0.7, marginBottom: '0.5rem', letterSpacing: '0.1em', textTransform: 'uppercase' }}>
            <a href="/" style={{ color: 'rgba(255,255,255,0.7)', textDecoration: 'none' }}>MetroGuia</a> → León
          </p>
          ...
          <p style={{ fontSize: '1.1rem', opacity: 0.85, maxWidth: '580px', margin: '0 auto 1rem' }}>
            El Sistema Integrado de Transporte de León (SIT) opera con tecnología Optibus en 4 corredores BRT que cubren la ciudad del calzado más grande de Latinoamérica.
          </p>
          <p style={{ opacity: 0.7, fontSize: '0.95rem' }}>Bajío · A 30 min de Guanajuato UNESCO</p>
        </div>
      </section>
        ...
        <div className="container" style={{ maxWidth: '700px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', gap: '1.5rem', marginBottom: '3rem' }}>
            <div style={{ background: '#f8f9fa', borderRadius: '12px', padding: '1.5rem', textAlign: 'center' }}>
              <div style={{ fontSize: '1.75rem', fontWeight: 800, color: '#10B981', fontFamily: 'Syne, sans-serif' }}>4</div>
              <div style={{ fontSize: '0.8rem', color: '#666', marginTop: '0.25rem' }}>Líneas / Corredores</div>
            </div>
            <div style={{ background: '#f8f9fa', borderRadius: '12px', padding: '1.5rem', textAlign: 'center' }}>
              <div style={{ fontSize: '1.75rem', fontWeight: 800, color: '#10B981', fontFamily: 'Syne, sans-serif' }}>~70</div>
              <div style={{ fontSize: '0.8rem', color: '#666', marginTop: '0.25rem' }}>Estaciones / Paradas</div>
            </div>
            <div style={{ background: '#f8f9fa', borderRadius: '12px', padding: '1.5rem', textAlign: 'center' }}>
              <div style={{ fontSize: '1.75rem', fontWeight: 800, color: '#10B981', fontFamily: 'Syne, sans-serif' }}>~50</div>
              <div style={{ fontSize: '0.8rem', color: '#666', marginTop: '0.25rem' }}>Kilómetros de red</div>
            </div>
          </div>
          <div style={{ background: '#10B98115', border: '1px solid #10B98130', borderRadius: '12px', padding: '1.5rem', marginBottom: '2.5rem' }}>
            <p style={{ margin: 0, color: '#444', lineHeight: 1.7 }}>
              El Sistema Integrado de Transporte de León (SIT) opera con tecnología Optibus en 4 corredores BRT que cubren la ciudad del calzado más grande de Latinoamérica. Desde León puedes llegar fácilmente a Guanajuato, San Miguel de Allende y la Ruta Colonial.
            </p>
          </div>
