...
export async function generateMetadata({ params }) {
  ...
  const languages = {}
  LANGUAGES.forEach(l => {
    languages[l] = l === 'es' ? baseUrl : `${baseUrl}/${l}`
  })
  languages['x-default'] = baseUrl

  return {
    title: t(translations, 'home.heroTitle') + ' — MetroGuia.mx',
    description: t(translations, 'home.heroSubtitle'),
    alternates: {
      canonical: url,
      languages,
    },
    openGraph: {
      title: t(translations, 'home.heroTitle'),
      description: t(translations, 'home.heroSubtitle'),
      url,
...
export default function LandingPageLang({ params }) {
  ...
  const proximamente = [
    { id: 'puebla', nombre: 'Puebla', sistema: 'RUTA BRT', color: '#8B5CF6', href: `/${lang}/puebla/` },
    { id: 'merida', nombre: 'Mérida', sistema: 'SIT Mérida', color: '#F59E0B', href: `/${lang}/merida/` },
    { id: 'leon', nombre: 'León', sistema: 'Optibus SIT', color: '#10B981', href: `/${lang}/leon/` },
    { id: 'tren-maya', nombre: 'Tren Maya', sistema: 'Ferroviario', color: '#0EA5E9', href: `/${lang}/tren-maya/` },
    { id: 'queretaro', nombre: 'Querétaro', sistema: 'Q-BUS BRT', color: '#EF4444', href: `/${lang}/queretaro/` },
    { id: 'chihuahua', nombre: 'Chihuahua', sistema: 'Chepe Express', color: '#D97706', href: `/${lang}/chihuahua/` },
    { id: 'tijuana', nombre: 'Tijuana', sistema: 'SITT BRT', color: '#6B7280', href: `/${lang}/tijuana/` },
    { id: 'toluca', nombre: 'Toluca', sistema: 'Tren Interurbano', color: '#7C3AED', href: `/${lang}/toluca/` },
  ]
    ...
    <div>
      ...
      <section style={{
        ...
        <div style={{ maxWidth: '720px', margin: '0 auto', textAlign: 'center' }}>
          <div style={{
            ...
            {t(translations, 'nav.worldCup')} — CDMX · GDL · MTY
          </div>
      ...
      <section style={{
        ...
        <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
          <h6 style={{
            ...
            {t(translations, 'home.popularRoutes')}
          </h6>
          <div style={{
            display: 'flex',
            gap: '0.75rem',
            ...
            {ciudades.map((ciudad) => (
              ...
              >
                ...
                <div style={{
                  ...
                  {[
                    { val: ciudad.stats.estaciones, label: t(translations, 'home.stationsCount') },
                    { val: ciudad.stats.lineas, label: t(translations, 'home.linesCount') },
      ...
      <section style={{
        ...
        <div style={{
          ...
          {[
            { val: '275+', label: t(translations, 'home.stationsCount') },
            { val: '17', label: t(translations, 'home.linesCount') },
            { val: '3', label: t(translations, 'home.citiesCount') },
            { val: '13', label: t(translations, 'home.matchesCount') },
          ].map((s) => (
            <div key={s.label}>
              <div style={{
                fontSize: '1.75rem',
