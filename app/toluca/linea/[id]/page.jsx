...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    openGraph: {
      title: linea.seo_title,
      description: linea.meta_description,
      url: `https://metroguia.mx/toluca/linea/${linea.id}`,
      type: 'website',
    },
    robots: {
      index: true,
    ...
    alternates: {
      canonical: `https://metroguia.mx/toluca/linea/${params.id}`,
      languages: {
...
export default function LineaTolucaPage({ params }) {
  const linea = lineasToluca.find(l => l.id === params.id);
  ...
  if (!linea) {
    return (
      <main style={{ maxWidth: '1200px', margin: '0 auto', padding: '40px 20px' }}>
        ...
        <p>La línea "{params.id}" no existe en Toluca.</p>
      ...
      <section style={heroStyles}>
        <div style={heroContentStyles}>
          ...
          <p style={{ fontSize: '18px', marginBottom: '5px' }}>
            ...
            {linea.id === 'TI' ? 'Tren Interurbano' : `Mexibús ${linea.id}`} ({linea.colorNombre})
          </p>
        ...
        <div style={{ marginTop: '40px' }}>
          ...
          <div style={gridStyles}>
            <div style={cardStyles}>
              ...
              <p style={{ fontSize: '14px', color: '#374151' }}>
                <strong>Paradas:</strong> {linea.total}
              </p>
            </div>
            <div style={cardStyles}>
              <h3 style={{ fontSize: '16px', fontWeight: 'bold', color: linea.color, marginBottom: '10px' }}>
            ...
            <div style={cardStyles}>
              ...
              <p style={{ fontSize: '14px', color: '#374151' }}>
                {linea.estaciones_turisticas?.length || 0} estaciones con atracciones
              </p>
            </div>
          </div>
        </div>
