...
export async function generateMetadata(props) {
  ...
  return {
    ...
    alternates: { canonical: `/cdmx/trolebus/estacion/${estacion.slug}/` },
  }
}

export default async function TrolebusEstacionPage(props) {
  const params = await props.params;
  const estacion = sistema.estacionesPorSlug.get(params.slug)
  if (!estacion) {
    return (
      <section className="section">
        <div className="container-narrow" style={{ textAlign: 'center' }}>
          ...
          <p><a href="/cdmx/trolebus/">Ver {sistema.nombre}</a></p>
        </div>
      </section>
    )
  }
