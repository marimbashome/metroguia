...
export async function generateMetadata(props) {
  ...
  return {
    ...
    alternates: { canonical: `/cdmx/cablebus/estacion/${estacion.slug}/` },
  }
}

export default async function CablebusEstacionPage(props) {
  const params = await props.params;
  const estacion = sistema.estacionesPorSlug.get(params.slug)
  if (!estacion) {
    return (
      <section className="section">
        <div className="container-narrow" style={{ textAlign: 'center' }}>
          ...
          <p><a href="/cdmx/cablebus/">Ver {sistema.nombre}</a></p>
        </div>
      </section>
    )
  }
