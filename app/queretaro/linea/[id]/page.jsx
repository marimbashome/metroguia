...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    openGraph: {
      title: linea.seo_title,
      description: linea.meta_description,
      url: `https://metroguia.mx/queretaro/linea/${linea.id}`,
      type: 'website',
    },
    robots: {
      index: true,
...
export default function LineaQueretaroPage({ params }) {
  const linea = lineasQueretaro.find(l => l.id === params.id);
  ...
  if (!linea) {
    return (
      <main style={{ maxWidth: '1200px', margin: '0 auto', padding: '40px 20px' }}>
        ...
        <p>La línea "{params.id}" no existe en el Q-BUS de Querétaro.</p>
