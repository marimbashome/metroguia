...
export async function generateMetadata({ params }) {
  ...
  if (!linea) {
    return { title: 'Circuito no encontrado' };
  }
  return {
    ...
    openGraph: {
      title: linea.seo_title,
      description: linea.meta_description,
      url: `https://metroguia.mx/oaxaca/linea/${linea.id}`,
      type: 'website',
    },
    robots: {
      index: true,
...
export default function LineaOaxacaPage({ params }) {
  const linea = lineasOaxaca.find((l) => l.id === params.id);
  if (!linea) {
    return (
      <main style={{ padding: '40px 20px', textAlign: 'center' }}>
        <h1>Circuito no encontrado</h1>
  ...
  const estacionesLinea = estacionesOaxaca.filter((e) => e.linea === linea.id);
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 3,
        name: linea.nombre,
        item: `https://metroguia.mx/oaxaca/linea/${linea.id}/`
      }
    ]
  }
  ...
  return (
    <main style={{ backgroundColor: '#ffffff' }}>
      ...
      <section style={{ ...containerStyles, ...sectionStyles, paddingTop: '40px' }}>
        ...
        <h2 style={sectionTitleStyles}>Descripción del Circuito</h2>
            ...
            return (
              <div key={idx} style={rutaParadaStyles}>
                ...
                <div style={rutaActivityStyles}>
                  <Link
                    href={`/oaxaca/estacion/${parada.estacion}`}
        ...
        <section style={{ ...containerStyles, ...sectionStyles, paddingTop: '40px' }}>
          ...
          <div style={gridStyles}>
            {linea.estaciones_turisticas.map((slugTuristico) => {
              const estacion = estacionesOaxaca.find((e) => e.slug === slugTuristico);
      ...
      <section style={{ ...containerStyles, ...sectionStyles, paddingTop: '40px' }}>
        ...
        <h2 style={sectionTitleStyles}>Todas las Estaciones del Circuito {linea.id}</h2>
        ...
        <div style={gridStyles}>
          <div style={{ backgroundColor: '#f9fafb', padding: '20px', borderRadius: '8px', border: `1px solid #e5e7eb` }}>
            ...
            <p style={{ fontSize: '14px', color: '#374151', lineHeight: '1.6', margin: 0 }}>
              De 6:00 AM a 10:00 PM. Frecuencia cada 10-15 minutos durante el día.
            </p>
          </div>
          <div style={{ backgroundColor: '#f9fafb', padding: '20px', borderRadius: '8px', border: `1px solid #e5e7eb` }}>
            <h3 style={{ fontSize: '16px', fontWeight: 'bold', color: linea.color, marginBottom: '10px' }}>
            ...
            <p style={{ fontSize: '14px', color: '#374151', lineHeight: '1.6', margin: 0 }}>
              Tarjeta inteligente reutilizable. Pases especiales para turistas disponibles.
            </p>
          </div>
          <div style={{ backgroundColor: '#f9fafb', padding: '20px', borderRadius: '8px', border: `1px solid #e5e7eb` }}>
            <h3 style={{ fontSize: '16px', fontWeight: 'bold', color: linea.color, marginBottom: '10px' }}>
            ...
            <p style={{ fontSize: '14px', color: '#374151', lineHeight: '1.6', margin: 0 }}>
              Paradas accesibles para personas con movilidad reducida. Guías turísticas disponibles.
            </p>
          </div>
        </div>
      </section>
      ...
      <section style={{ ...containerStyles, paddingTop: '40px', paddingBottom: '40px', textAlign: 'center' }}>
        <h2 style={sectionTitleStyles}>Explora Más de Oaxaca</h2>
