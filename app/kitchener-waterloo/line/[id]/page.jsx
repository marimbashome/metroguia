...
export async function generateMetadata({ params }) {
  ...
  return {
    title: `Ion ${linea.colorNombre} Line — Kitchener-Waterloo | MetroGuia`,
    description: linea.descripcion.substring(0, 160),
    openGraph: {
      title: `Ion ${linea.colorNombre} Line`,
      description: linea.descripcion.substring(0, 160),
      url: `https://metroguia.mx/kitchener-waterloo/line/${linea.id}`,
    },
  };
}

export default function LineKitchenerWaterlooPage({ params }) {
  const linea = lineasKitchenerWaterloo.find((l) => l.id === params.id);
