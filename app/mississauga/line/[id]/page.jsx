...
export async function generateMetadata({ params }) {
  ...
  return {
    title: `MiWay Rapid Transit ${linea.colorNombre} Line — Mississauga | MetroGuia`,
    description: linea.descripcion.substring(0, 160),
    openGraph: {
      title: `MiWay Rapid Transit ${linea.colorNombre} Line`,
      description: linea.descripcion.substring(0, 160),
      url: `https://metroguia.mx/mississauga/line/${linea.id}`,
    },
  };
}

export default function LineMississaugaPage({ params }) {
  const linea = lineasMississauga.find((l) => l.id === params.id);
