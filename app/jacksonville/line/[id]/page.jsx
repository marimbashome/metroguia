...
export async function generateMetadata({ params }) {
  ...
  return {
    title: `Skyway ${linea.colorNombre} Line — Jacksonville | MetroGuia`,
    description: linea.descripcion.substring(0, 160),
    openGraph: {
      title: `Skyway ${linea.colorNombre} Line`,
      description: linea.descripcion.substring(0, 160),
      url: `https://metroguia.mx/jacksonville/line/${linea.id}`,
    },
  };
}

export default function LineJacksonvillePage({ params }) {
  const linea = lineasJacksonville.find((l) => l.id === params.id);
