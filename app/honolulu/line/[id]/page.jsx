...
export async function generateMetadata({ params }) {
  ...
  return {
    title: `Skyline ${linea.colorNombre} Line — Honolulu | MetroGuia`,
    description: linea.descripcion.substring(0, 160),
    openGraph: {
      title: `Skyline ${linea.colorNombre} Line`,
      description: linea.descripcion.substring(0, 160),
      url: `https://metroguia.mx/honolulu/line/${linea.id}`,
    },
  };
}

export default function LineHonoluluPage({ params }) {
  const linea = lineasHonolulu.find((l) => l.id === params.id);
