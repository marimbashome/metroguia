...
export async function generateMetadata({ params }) {
  ...
  return {
    title: `Tren Urbano ${linea.colorNombre} Line — San Juan | MetroGuia`,
    description: linea.descripcion.substring(0, 160),
    openGraph: {
      title: `Tren Urbano ${linea.colorNombre} Line`,
      description: linea.descripcion.substring(0, 160),
      url: `https://metroguia.mx/san-juan/line/${linea.id}`,
    },
  };
}

export default function LineSanJuanPage({ params }) {
  const linea = lineasSanJuan.find((l) => l.id === params.id);
