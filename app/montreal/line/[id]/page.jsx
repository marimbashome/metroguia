...
export async function generateMetadata({ params }) {
  ...
  return {
    title: `STM Metro ${linea.colorNombre} Line — Montreal | MetroGuia`,
    description: linea.descripcion.substring(0, 160),
    openGraph: {
      title: `STM Metro ${linea.colorNombre} Line`,
      description: linea.descripcion.substring(0, 160),
      url: `https://metroguia.mx/montreal/line/${linea.id}`,
    },
  };
}

export default function LineMontrealPage({ params }) {
  const linea = lineasMontreal.find((l) => l.id === params.id);
