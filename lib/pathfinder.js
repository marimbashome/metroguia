...
import { grafoJacksonville } from "@/data/jacksonville/grafo";
import { grafoAustin } from "@/data/austin/grafo";
import { grafoCincinnati } from "@/data/cincinnati/grafo";
import { grafoElPaso } from "@/data/el-paso/grafo";
import { grafoOrlando } from "@/data/orlando/grafo";
import { grafoSanJuan } from "@/data/san-juan/grafo";
import { grafoTampa } from "@/data/tampa/grafo";
import { grafoTucson } from "@/data/tucson/grafo";
import { grafoOklahomaCity } from "@/data/oklahoma-city/grafo";
import { grafoNashville } from "@/data/nashville/grafo";
import { grafoMilwaukee } from "@/data/milwaukee/grafo";
import { grafoNewark } from "@/data/newark/grafo";
import { grafoKitchenerWaterloo } from "@/data/kitchener-waterloo/grafo";
import { grafoMississauga } from "@/data/mississauga/grafo";
...
const GRAFO_MAP = {
  ...
  montreal: grafoMontreal,
  calgary: grafoCalgary,
  edmonton: grafoEdmonton,
  ottawa: grafoOttawa,
  detroit: grafoDetroit,
  cleveland: grafoCleveland,
  'las-vegas': grafoLasVegas,
  'san-jose': grafoSanJose,
  'new-orleans': grafoNewOrleans,
  buffalo: grafoBuffalo,
  honolulu: grafoHonolulu,
  norfolk: grafoNorfolk,
  jacksonville: grafoJacksonville,
  austin: grafoAustin,
  cincinnati: grafoCincinnati,
  'el-paso': grafoElPaso,
  orlando: grafoOrlando,
  'san-juan': grafoSanJuan,
  tampa: grafoTampa,
  tucson: grafoTucson,
  'oklahoma-city': grafoOklahomaCity,
  nashville: grafoNashville,
  milwaukee: grafoMilwaukee,
  newark: grafoNewark,
  'kitchener-waterloo': grafoKitchenerWaterloo,
  mississauga: grafoMississauga,
};
