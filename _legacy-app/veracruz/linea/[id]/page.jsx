...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    openGraph: {
      title: linea.seo_title,
      description: linea.meta_description,
      url: `https://metroguia.mx/veracruz/linea/${linea.id}`,
      type: 'website',
    },
    robots: {
      index: true,
    ...
    alternates: {
      canonical: `https://metroguia.mx/veracruz/linea/${params.id}`,
      languages: {
...
export default function LineaVeracruzPage({ params }) {
  const linea = lineasVeracruz.find((l) => l.id === params.id);
  if (!linea) {
    return (
      <main style={{ padding: '40px 20px', textAlign: 'center' }}>
        ...
        <p style={{ marginTop: '20px' }}>
          <Link href="/veracruz" style={{ color: '#DC2626', textDecoration: 'underline' }}>
            Volver a Veracruz
          </Link>
        </p>
      </main>
  ...
  return (
    <main style={{ backgroundColor: '#ffffff' }}>
            ...
            return (
              <div key={idx} style={rutaParadaStyles}>
                ...
                <div style={rutaActivityStyles}>
                  <Link
                    href={`/veracruz/estacion/${parada.estacion}`}
        ...
        <section style={{ ...containerStyles, ...sectionStyles, paddingTop: '40px' }}>
          ...
          <div style={gridStyles}>
            {linea.estaciones_turisticas.map((slugTuristico) => {
              const estacion = estacionesVeracruz.find((e) => e.slug === slugTuristico);
      ...
      <section style={{ ...containerStyles, paddingTop: '40px', paddingBottom: '40px', textAlign: 'center' }}>
        <h2 style={sectionTitleStyles}>Explora Más de Veracruz</h2>
        <div style={{ display: 'flex', gap: '10px', justifyContent: 'center', flexWrap: 'wrap' }}>
          <Link href="/veracruz" style={buttonStyles}>
            Volver a Veracruz
          </Link>
        </div>
      </section>
