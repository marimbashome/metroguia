export const estacionesPhoenix = [
  {
    ...
    "meta_description": "Estación 19th Ave/Montebello, terminal oeste del Valley Metro Light Rail en Phoenix. Acceso a zonas residenciales oeste, Park & Ride, y servicios.",
    "h1": "Estación 19th Ave/Montebello | Phoenix Valley Metro",
    "intro": "Terminal occidental del Valley Metro Light Rail, punto de acceso a los barrios residenciales del oeste de Phoenix. Excelente opción para viajeros que llegan desde áreas periféricas con servicio de estacionamiento.",
    "tips": [
      "Terminal con Park & Ride para visitantes con auto",
      "Acceso completo ADA con elevador y rampas",
      "Punto de partida para explorar Phoenix occidental"
    ],
  ...
  },
  {
    ...
    "meta_description": "Estación 24th Ave/Thomas en Valley Metro Light Rail. Acceso a comercios en la avenida Thomas y barrios residenciales del centro-oeste de Phoenix.",
    "h1": "Estación 24th Ave/Thomas | Phoenix Valley Metro",
    "intro": "Estación de servicio en la corriente comercial de Thomas Road, conectando barrios residenciales con opciones de compras y servicios locales. Excelente punto intermedio para explorar el centro-oeste de Phoenix.",
    "tips": [
      "Zona comercial activa con tiendas y restaurantes",
      "Acceso a barrios residenciales bien establecidos",
      "Conexión rápida al centro de Phoenix (10 minutos)"
    ],
  ...
  },
  {
    ...
    "meta_description": "Estación 32nd Ave/Washington en Valley Metro Light Rail de Phoenix. Acceso a barrios residenciales del centro-oeste.",
    "h1": "Estación 32nd Ave/Washington | Phoenix Valley Metro",
    "intro": "Estación en el corredor de Washington, sector residencial establecido del centro-oeste de Phoenix. Ofrece acceso rápido a servicios locales y conectividad con el centro de la ciudad.",
    "tips": [
      "Punto de acceso a barrios tranquilos y seguros",
      "Servicios locales variados en las proximidades",
      "Conexión eficiente al downtown de Phoenix"
    ],
    "mejor_horario": "Cualquier hora",
  ...
  },
  {
    ...
    "intro": "Estación central en el corazón del downtown de Phoenix. Punto de acceso privilegiado al Arts District, Roosevelt Row, galerías, restaurantes contemporáneos y la vida cultural vibrante de la ciudad.",
    "tips": [
      "Centro nevrálgico del Arts District de Phoenix",
      "Múltiples galerías de arte y espacios creativos en los alrededores",
      "Restaurantes locales y cafés boutique",
      "Punto de transferencia a autobuses del centro"
    ],
  ...
  },
  {
    ...
    "intro": "Centro de comercio y transportación del downtown de Phoenix. Metro Center Drive conecta con centros comerciales, distritos de negocios y servicios. Punto de transbordo multimodal importante.",
    "tips": [
      "Centro comercial con tiendas variadas",
      "Múltiples opciones de transporte público",
      "Zona de compras y servicios",
      "Acceso a hoteles y servicios turísticos"
    ],
  ...
  },
  {
    ...
    "intro": "Estación en el corazón del distrito cultural y de entretenimiento del downtown de Phoenix. Acceso directo a teatros, bares, restaurantes y espacios para eventos culturales.",
    "tips": [
      "Vida nocturna activa y entretenimiento",
      "Teatros y salas de conciertos cercanas",
  ...
  },
  {
    ...
    "intro": "Estación central en el corazón del downtown de Phoenix. Conexión estratégica para negocios, servicios gubernamentales y transporte hacia todas las áreas de la ciudad.",
    "tips": [
      "Centro administrativo de Phoenix",
      "Fácil acceso a servicios públicos",
      "Hub de transporte multimodal",
      "Zona de oficinas y negocios"
    ],
  ...
  },
  {
    ...
    "meta_description": "Estación Camelback Road en Valley Metro Light Rail. Acceso a tiendas de lujo y restaurants de alta cocina.",
    "h1": "Estación Camelback Road | Phoenix Valley Metro",
    "intro": "Estación en una de las zonas más elegantes de Phoenix. Camelback Road ofrece acceso a tiendas de diseño, boutiques exclusivas y restaurantes de alta cocina.",
    "tips": [
      "Zona residencial y comercial de lujo",
      "Tiendas y boutiques de diseño",
      "Restaurantes de alta categoría",
      "Bares y locales exclusivos"
    ],
  ...
  },
  {
    ...
    "meta_description": "Estación Highland Avenue en Valley Metro Light Rail, acceso a barrios residenciales del norte de Phoenix.",
    "h1": "Estación Highland Avenue | Phoenix Valley Metro",
    "intro": "Estación en el norte central de Phoenix, sirviendo comunidades residenciales establecidas. Acceso a barrios tranquilos con comercios locales y servicios.",
    "tips": [
      "Barrios residenciales seguros y tranquilos",
      "Compras locales de calidad",
      "Conexión rápida al centro de Phoenix"
    ],
    "mejor_horario": "Cualquier hora",
    "mundial_relevancia": "Barrios residenciales de Phoenix",
  ...
  },
  {
    ...
    "meta_description": "Estación Thomas Road en Valley Metro Light Rail, comercio y servicios en el corredor de Thomas Road.",
    "h1": "Estación Thomas Road | Phoenix Valley Metro",
    "intro": "Estación en el corredor comercial de Thomas Road, ofereciendo acceso a tiendas minoristas, restaurants y servicios variados. Punto estratégico para shopper y turistas.",
    "tips": [
      "Tiendas minoristas variadas",
  ...
  },
  {
    ...
    "meta_description": "Estación Bethany Home Road en Valley Metro Light Rail, acceso a barrios residenciales del norte de Phoenix.",
    "h1": "Estación Bethany Home Road | Phoenix Valley Metro",
    "intro": "Estación en el norte de Phoenix sirviendo comunidades residenciales. Conexión conveniente para explorar el lado norte de la ciudad.",
    "tips": [
      "Barrios residenciales bien establecidos",
  ...
  },
  {
    ...
    "intro": "Estación dedicada a eventos y deportes, punto de acceso principal para Chase Field (Diamondbacks), conciertos, festivales y eventos especiales. Perfecta para visitantes que desean experimentar la vida deportiva de Phoenix.",
    "tips": [
      "Acceso directo a Chase Field para partidos de Diamondbacks",
      "Conciertos y eventos especiales en venues cercanos",
      "Arizona State Fairgrounds para festivales",
      "Servicios de parking y tránsito especial en eventos"
    ],
  ...
  },
  {
    ...
    "intro": "Puerta al vibrante downtown de Tempe, conectando con Mill Avenue, Tempe Town Lake y el campus de Arizona State University. Zona de estudiantes, restaurantes, bares y vida nocturna activa.",
    "tips": [
      "Mill Avenue llena de bares y restaurantes estudiantes",
      "Tempe Town Lake para caminar y actividades acuáticas",
      "Acceso a ASU Sun Devil Stadium para eventos",
      "Vida nocturna activa los fines de semana",
  ...
  },
  {
    ...
    "intro": "Estación en el corazón del campus de Arizona State University, una de las universidades más grandes de Estados Unidos. Acceso directo a instalaciones académicas, museos, eventos deportivos y vida de campus.",
    "tips": [
      "Campus principal de ASU Sun Devil",
      "Museos y galerías de arte en ASU",
      "Sun Devil Stadium para eventos deportivos",
      "Arquitectura icónica de ASU",
      "Ambiente académico vibrante"
    ],
  ...
  },
  {
    ...
    "intro": "Estación en el corazón del corredor tecnológico de Tempe, donde se concentran empresas de tecnología, parques empresariales y servicios corporativos. Perfecta para turistas de negocios.",
    "tips": [
      "Distrito tecnológico importante",
      "Empresas Fortune 500 en la zona",
      "Parques empresariales modernos",
      "Servicios y restaurantes para negocios",
  ...
  },
  {
    ...
    "meta_description": "Estación Signal Butte en Valley Metro Light Rail, acceso a barrios residenciales de Gilbert.",
    "h1": "Estación Signal Butte | Phoenix Valley Metro",
    "intro": "Estación en el este de Phoenix sirviendo a Gilbert, comunidad residencial de rápido crecimiento. Acceso a barrios modernos, servicios comunitarios y vida local auténtica.",
    "tips": [
  ...
  },
  {
    ...
    "intro": "Centro de la ciudad de Gilbert, con un historic downtown revitalizado, tiendas, restaurantes locales y espacios de recreación. Perfecta para explorar la comunidad local fuera del bullicio de Phoenix.",
    "tips": [
      "Historic downtown de Gilbert recientemente revitalizado",
      "Tiendas locales y restaurantes independientes",
      "Town Square para eventos y reuniones",
      "Ambiente comunitario tranquilo",
  ...
  },
  {
    ...
    "intro": "Centro cultural y comercial de Mesa, con un vibrante downtown revitalizado. Mesa Main Street ofrece galerías de arte, restaurants, tiendas locales y espacios para eventos culturales.",
    "tips": [
      "Mesa Arts Center para exposiciones y performances",
      "Historic downtown revitalizado y seguro",
      "Tiendas locales y restaurantes independientes",
      "Ambiente cultural dinámico",
  ...
  },
  {
    ...
    "intro": "Terminal oriental del Valley Metro Light Rail, punto de partida y llegada para el este del valle. Equipada con Park & Ride, servicios de transporte y conexiones locales.",
    "tips": [
      "Terminal con Park & Ride para visitantes",
      "Servicios de transporte local",
      "Acceso completo ADA",
      "Punto de transferencia regional",
