export const estacionesNashville = [
  {
    ...
    "intro": "Terminal principal del WeGo Star en el corazón del centro de Nashville con acceso a Broadway y el riverfront. Tarifa $5.25 por viaje.",
    "tips": [
      "Tarifa: $5.25 por viaje, o $13 pase de día",
      "Terminal central: conexión con autobuses MTA",
      "Broadway acceso: honky-tonks y música en vivo"
    ],
    "mejor_horario": "Tardes (3pm-9pm) para Broadway y entretenimiento",
    "mundial_relevancia": "No direct FIFA relevance",
    "descripcion_turistica": "Riverfront Station es el punto de partida ideal para explorar el centro turístico de Nashville con acceso a Broadway, honky-tonks y el riverfront del Cumberland.",
    "accesibilidad": {
      "elevador": true,
      "rampa": true,
      "piso_tactil": true,
