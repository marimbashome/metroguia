export const estacionesVeracruz = [
  {
    ...
    "tips": [
      "Explore el Acuario de Veracruz",
      "Disfruta el Malecón Portuario",
      "Observa barcos internacionales",
      "Puerto operativo 24 horas"
    ],
  ...
  },
  {
    ...
    "tips": [
      "Visite el Zócalo al atardecer",
      "Explore la Catedral Metropolitana",
      "Disfruta presentaciones de la Orquesta Sinfónica",
      "Descubre galerías de arte contemporáneo"
    ],
  ...
  },
  {
    ...
    "tips": [
      "Visite el museo 10:00-18:00",
      "Explore el Paseo de las Murallas",
      "Aprenda sobre arquitectura militar colonial",
  ...
  },
  {
    ...
    "tips": [
      "Nada en el Golfo de México",
      "Disfruta mariscos frescos",
      "Visita bares y cantinas históricas",
      "Vistas de barcos en puerto"
    ],
  ...
  },
  {
    ...
    "linea": "BRT Veracruz",
    "tipo_zona": "turístico",
    "descripcion_turistica": "Al salir de la estación Acuario, sumérgete en el Acuario de Veracruz, hogar de tiburones, tortugas y exhibiciones interactivas que revelan la biodiversidad del Golfo. A pocos metros, la Tienda de Recuerdos ofrece artesanías locales como hamacas y cerámica talavera, perfectas para llevar un pedacito de Veracruz. Para el almuerzo, el Restaurante Acuario sirve fresquísimos platillos de mar, como el famoso huachinango a la veracruzana, mientras disfrutas de vistas al puerto. No te pierdas el paseo marítimo adyacente, ideal para fotos al atardecer con el faro como telón de fondo.",
    "lugares_cercanos": [
      {
        "nombre": "Acuario de Veracruz",
        "tipo": "Museo",
    ...
    "intro": "Descubre la vibrante costa veracruzana a un paso del Acuario, donde historia, sabor y mar se unen para turistas curiosos.",
    "tips": [
      "Lleva efectivo pequeño para comprar artesanías en la tienda, ya que algunos puestos no aceptan tarjetas.",
      "Llega temprano si deseas observar los shows de alimentación de tiburones, que suelen iniciar a las 10:30 am y 3:00 pm.",
      "Usa protector solar y sombrero; la zona del puerto es muy soleada y el viento puede ser intenso."
    ],
    "mejor_horario": "Mañanas entre semana, antes de las 11 am, para evitar multitudes y disfrutar de los shows del acuario con tranquilidad.",
  ...
  },
  {
    ...
    "tips": [
      "Disfruta restaurantes de mariscos gourmet",
      "Paseos en barco por río y bahía",
      "Compra en paseo Boca del Río",
      "Servicios hasta 22:00"
    ],
  ...
  },
  {
    ...
    "tips": [
      "Prueba pescado capturado localmente",
      "Compra en mercado de pescado fresco",
      "Disfruta ambiente local auténtico",
      "Mercado activo desde 6:00"
    ],
  ...
  },
  {
    ...
    "descripcion_turistica": "A pocos pasos de la estación, el Mirador Loma de Lara ofrece una vista de 360° del puerto y la bahía, ideal para fotos al atardecer. Justo al lado, el Centro Comercial Loma de Lara reúne boutiques locales, artesanías veracruzanas y una amplia oferta gastronómica, desde tacos de camarón hasta cafés de origen. El Parque Recreativo Loma de Lara invita a caminar entre áreas verdes, juegos infantiles y un pequeño lago donde puedes rentar kayaks o simplemente relajarte bajo la sombra de los ahuehuetes. No pierdas la oportunidad de probar el helado de cajeta artesanal en la zona de food trucks del parque.",
    "lugares_cercanos": [
      {
    ...
    "intro": "Descubre Loma de Lara, donde la vista panorámica, compras y diversión al aire libre se funden en un solo destino vibrante.",
    "tips": [
      "Lleva tu cámara con batería extra; la luz del atardecer en el mirador crea fotos espectaculares.",
      "Usa calzado cómodo para explorar el parque y sus senderos; hay zonas de arena y rutas pavimentadas.",
      "Compra tus recuerdos en el centro comercial antes de la hora pico (12‑14 h) para evitar filas y encontrar mejores ofertas."
    ],
    "mejor_horario": "Mañanas entre semana, antes de las 10 a.m., para disfrutar de vistas despejadas y menos concurrencia.",
  ...
  },
  {
    ...
    "linea": "BRT Veracruz",
    "tipo_zona": "cultural",
    "descripcion_turistica": "Al salir de la estación, encontrarás a pocos pasos el emblemático Museo de Antropología de Xalapa, donde podrás admirar colecciones prehispánicas, artefactos de la región y exposiciones temporales de renombre. A su lado, el Parque Museo ofrece áreas verdes, esculturas al aire libre y espacios para descansar mientras disfrutas de la vista al río. No te pierdas la Tienda del Museo, ideal para adquirir artesanías locales, libros especializados y recuerdos únicos que celebran la identidad veracruzana. Completa tu visita con una caminata guiada por los jardines y participa en talleres interactivos que se programan los fines de semana.",
    "lugares_cercanos": [
      {
    ...
    "intro": "Descubre la riqueza cultural de Veracruz en la estación que te lleva al corazón del Museo de Antropología de Xalapa.",
    "tips": [
      "Lleva calzado cómodo; el museo y el parque tienen recorridos extensos y caminos de tierra.",
      "Compra tus boletos con anticipación en línea para evitar filas, especialmente durante ferias culturales.",
      "Visita la Tienda del Museo al final para aprovechar descuentos exclusivos en artesanías y guías ilustradas."
    ],
    "mejor_horario": "Mañanas entre semana, antes de las 11:00 h, para disfrutar de espacios más tranquilos y menor afluencia de visitantes.",
  ...
  },
  {
    ...
    "tips": [
      "Prueba pescado del día recién capturado",
      "Compra captura fresca directamente",
      "Disfruta restaurantes frente a caleta",
      "Activa desde madrugada"
    ],
    "mejor_horario": "Temprano para pescado fresco",
  ...
  },
  {
    ...
    "tips": [
      "Servicios disponibles 24 horas",
      "Compra boletos con anticipación",
      "Hotel Terminal para conexiones",
      "Tiendas y restaurantes en terminal"
    ],
