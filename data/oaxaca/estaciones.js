export const estacionesOaxaca = [
  {
    ...
    "tips": [
      "Llegue con anticipación para vuelos internacionales",
      "Rente vehículos en la terminal",
      "Hotel Gateway ofrece conexiones rápidas",
  ...
  },
  {
    ...
    "tips": [
      ...
      "Explore el Mercado Benito Juárez para artesanías",
      "Las galerías abren después de las 10:00",
      "Pruebe la cocina oaxaqueña auténtica"
    ],
  ...
  },
  {
    ...
    "tips": [
      ...
      "Explore el Jardín Etnobotánico",
      "Las galerías artesanales venden directamente",
      "La decoración interior es excepcional"
    ],
  ...
  },
  {
    ...
    "tips": [
      "Llegue temprano para evitar calor",
      "Explore el Museo de Sitio",
      "El mirador panorámico tiene vistas excepcionales",
      "Lleve protección solar"
    ],
  ...
  },
  {
    ...
    "tips": [
      "Explore los patrones geométricos de mosaicos",
      "Visite la Capilla Colonial",
      "Compre huipiles en tiendas de artesanías",
      "Lleve calzado cómodo para terrenos antiguos"
    ],
  ...
  },
  {
    ...
    "tips": [
      "Nada en las piscinas termales 8:00-17:00",
      "Lleve traje de baño",
      "El mirador ofrece fotografía espectacular",
      "Piscinas tienen propiedades terapéuticas"
    ],
  ...
  },
  {
    ...
    "tips": [
      "Visite temprano para variedad máxima",
      "Pruebe mole negro y rojo",
      "Compre textiles directamente de vendedores",
      "Negocie precios cortésmente"
    ],
  ...
  },
  {
    ...
    "tips": [
      "Prueba los comedores caseros",
      "Compra mole negro, rojo y amarillo",
      "Visita temprano para productos frescos",
      "Negocia precios en ingredientes"
    ],
  ...
  },
  {
    ...
    "tips": [
      "Explore galerías de arte contemporáneo",
      "Disfruta cafés tradicionales",
      "Compra artesanías de alta calidad",
      "Seguro para caminar de noche"
    ],
  ...
  },
  {
    ...
    "tips": [
      ...
      "Hotel Terminal cerca para conexiones",
  ...
  },
  {
    ...
    "tips": [
      "Degusta mezcal artesanal",
      "Visita fábricas tradicionales",
      "Explora el Museo del Mezcal",
      "Compra botellas de denominación de origen"
    ],
  ...
  },
  {
    ...
    "linea": "BRT Oaxaca",
    "tipo_zona": "natural",
    "descripcion_turistica": "A pocos pasos de la estación, el Árbol del Tule, con su tronco de más de 2,500 años, impresiona por su diámetro único. A su lado, el Templo de San Juan de Dios, una joya barroca del siglo XVI, ofrece visitas guiadas para admirar sus retablos dorados y su arquitectura colonial. La tienda de recuerdos 'Manos de Oaxaca' exhibe artesanías tradicionales, como alebrijes y textiles, perfectas para llevar un pedacito de la región. No te pierdas la oportunidad de probar el helado de guayaba o los chapulines tostados en los puestos callejeros cercanos, mientras disfrutas de la sombra del milenario árbol.",
    "lugares_cercanos": [
      {
    ...
    "intro": "Descubre la majestuosidad del Árbol del Tule y su entorno cultural en una parada llena de historia y sabor local.",
    "tips": [
      "Llega temprano (antes de las 10 am) para evitar la aglomeración de visitantes y disfrutar del árbol en tranquilidad.",
      "Lleva protector solar y sombrero; la zona está expuesta al sol y el árbol no ofrece mucha sombra.",
      "Compra tus artesanías directamente en la tienda para garantizar autenticidad y apoyar a los artesanos locales."
    ],
