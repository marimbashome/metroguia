export const estacionesVillahermosa = [
  ...
  },
  {
    ...
    "linea": "BRT Villahermosa",
    "tipo_zona": "urbano",
    "descripcion_turistica": "A tan solo unos pasos de la estación, el Centro Comercial Agua Blanca ofrece tiendas de moda, artesanías locales y cines de última generación. Al otro lado, el Parque Urbano Agua Blanca invita a pasear entre lagos artificiales, áreas verdes y esculturas contemporáneas, ideal para fotos y picnics. Cuando el hambre llama, los restaurantes La Casa del Sazón y El Fogón del Maya sirven auténtica cocina tabasqueña, mientras que cafés como Café Aroma y La Taza Verde brindan cafés de origen y postres artesanales. Todo está conectado por senderos peatonales, facilitando una jornada completa sin salir del barrio.",
    "lugares_cercanos": [
      {
    ...
    "intro": "¡Descubre la vibrante mezcla de compras, naturaleza y sabores en la zona de Agua Blanca, corazón pulsante de Villahermosa!",
    "tips": [
      "Lleva efectivo pequeño para los puestos de comida callejera del parque, ya que muchos no aceptan tarjetas.",
      "Aprovecha la tarjeta recargable BRT para obtener descuentos en tiendas del centro comercial y evitar filas en la taquilla del metro.",
      "Visita el parque al atardecer para disfrutar de la iluminación artística y evitar el calor del mediodía."
    ],
    "mejor_horario": "Mañanas entre semana, antes de las 10 am, para disfrutar de todo con menos aglomeraciones.",
    "mundial_relevancia": "Sin relevancia directa al Mundial 2026"
  },
  {
    "id": 4,
  ...
  },
  {
    ...
    "linea": "BRT Villahermosa",
    "tipo_zona": "urbano",
    "descripcion_turistica": "Al bajar en la estación Museo de Antropología, encontrarás el Museo Regional de la Universidad Autónoma de Tabasco, una joya que exhibe artefactos prehispánicos, piezas coloniales y exposiciones temporales de artistas locales. A pocos pasos, los Auditorios Culturales ofrecen presentaciones de danza folklórica, conciertos de marimba y charlas sobre la historia del estado. No te pierdas la Tienda del Museo, donde podrás adquirir artesanías de chaquira, textiles bordados y libros sobre la selva lacandona. Aprovecha los recorridos guiados gratuitos para profundizar en la cosmovisión maya y disfruta de las áreas verdes adyacentes, perfectas para un descanso al aire libre.",
    "lugares_cercanos": [
      {
    ...
    "intro": "Descubre la riqueza maya y la vibrante cultura tabasqueña a minutos del corazón de Villá",
    "tips": [
      "Lleva ropa ligera y calzado cómodo; el museo tiene varios pisos y recorridos extensos.",
      "Compra tus boletos con anticipación en línea para evitar filas en temporada alta.",
      "Visita la tienda del museo antes de salir; muchos productos son artesanales y solo se venden aquí."
    ],
    "mejor_horario": "Mañanas entre semana, especialmente de 9:00 a 11:30, para evitar multitudes y disfrutar de recorridos más tranquilos.",
    "mundial_relevancia": "Sin relevancia directa al Mundial 2026"
  },
  {
    "id": 9,
